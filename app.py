...
def my_form_post():
    if request.method == 'POST':
        ...
        if target==1:
            decision_making = 'Person is likely to have a heart disease'
        else:
            decision_making = 'Person is unlikely to have a heart disease'

        return render_template('home.html', target = target, decision_making = decision_making)
    else:
        return render_template('home.html')
